...
public class GetVoteDropTabCompleter implements TabCompleter{
	Main plugin;
	public GetVoteDropTabCompleter(Main pl){
		this.plugin = pl;
	}
	...
	public List<String> onTabComplete(CommandSender theSender, Command cmd, String commandLabel, String[] args){
		if(theSender.isOp()){
			if (commandLabel.equalsIgnoreCase("GetVoteDrop")){//GetVoteDrop <Player>
				if(args.length == 1){
