...
public class RemoveStatisticTabCompleter implements TabCompleter{
	Main plugin;
	public RemoveStatisticTabCompleter(Main pl){
		this.plugin = pl;
	}
	...
	public List<String> onTabComplete(CommandSender theSender, Command cmd, String commandLabel, String[] args){
		if(theSender.isOp()){
			if (commandLabel.equalsIgnoreCase("RemoveStatistic")){//RemoveStatistic <Player> <Statistic> <Value>
				if(args.length == 1){
