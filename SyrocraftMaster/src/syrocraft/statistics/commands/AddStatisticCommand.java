...
public class AddStatisticCommand implements CommandExecutor{
	Main plugin;
	public AddStatisticCommand(Main pl){
		this.plugin = pl;
	}

	public boolean onCommand(CommandSender theSender, Command cmd, String commandLabel, String[] args){
		if(theSender.isOp()){
			if (commandLabel.equalsIgnoreCase("AddStatistic")){//AddStatistic <Player> <Statistic> <Ammount>
				if(args.length == 3){
